    ...
    return (
        <section id="contact">
            ...
            <div className="social-btns">
                    <a href="https://www.linkedin.com/in/leonard-goetz/" target="_blank" rel="noopener noreferrer" id="linkedin" className="social-btn flex-center">
